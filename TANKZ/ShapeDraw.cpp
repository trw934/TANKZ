...
void DrawRectangle(float_t leftX, float_t bottomY, float_t rightX, float_t topY, char8_t r, char8_t g, char8_t b, bool8_t fill)
{
	glColor3ub(r, g, b);
	if (!fill) {
		glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	}
	glRectf(leftX, bottomY, rightX, topY);
